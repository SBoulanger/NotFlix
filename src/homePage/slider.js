        ...
        return (
            <div className="slider-arrows">
                <a className="arrow left" onClick={() => this.slideLeft()}>
                    <img src='http://icons.iconarchive.com/icons/iconsmind/outline/512/Arrow-Left-icon.png' />

                </a>
                <a className="arrow right" onClick={() => this.slideRight()}>
                    <img src='http://icons.iconarchive.com/icons/iconsmind/outline/512/Arrow-Right-icon.png' />
